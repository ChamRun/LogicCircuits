...
#endif
static const char *ng0 = "C:/Things/Programming/uni/LogicCircuits/Lab8/mux.v";
...
LAB19:    t277 = (t0 + 3408);
    ...
    *((unsigned int *)t293) = (t295 | t289);
    xsi_driver_vfirst_trans(t277, 0, 3);
    t296 = (t0 + 3328);
    *((int *)t296) = 1;
...
LAB34:    memcpy(t73, t143, 8);

LAB35:    goto LAB14;

LAB15:    xsi_vlog_unsigned_bit_combine(t3, 4, t68, 4, t73, 4);
    goto LAB19;

LAB17:    memcpy(t3, t68, 8);
    goto LAB19;
...
LAB46:    if (*((unsigned int *)t203) > 0)
        goto LAB47;

LAB48:    if (*((unsigned int *)t144) > 0)
        goto LAB49;

LAB50:    memcpy(t143, t213, 8);

LAB51:    goto LAB30;

LAB31:    xsi_vlog_unsigned_bit_combine(t73, 4, t138, 4, t143, 4);
    goto LAB35;

LAB33:    memcpy(t73, t138, 8);
    goto LAB35;

LAB36:    t176 = *((unsigned int *)t164);
...
LAB62:    if (*((unsigned int *)t273) > 0)
        goto LAB63;

LAB64:    if (*((unsigned int *)t214) > 0)
        goto LAB65;

LAB66:    memcpy(t213, t283, 8);

LAB67:    goto LAB46;

LAB47:    xsi_vlog_unsigned_bit_combine(t143, 4, t208, 4, t213, 4);
    goto LAB51;

LAB49:    memcpy(t143, t208, 8);
    goto LAB51;
...
LAB63:    xsi_vlog_unsigned_bit_combine(t213, 4, t278, 4, t283, 4);
    goto LAB67;

LAB65:    memcpy(t213, t278, 8);
    goto LAB67;

}


extern void work_m_00000000003096720366_3631796253_init()
{
	static char *pe[] = {(void *)Cont_34_0};
	xsi_register_didat("work_m_00000000003096720366_3631796253", "isim/tb_isim_beh.exe.sim/work/m_00000000003096720366_3631796253.didat");
